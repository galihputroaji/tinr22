...
class MKBahasainggrisWidget extends StatefulWidget {
  const MKBahasainggrisWidget({Key? key}) : super(key: key);

  @override
  _MKBahasainggrisWidgetState createState() => _MKBahasainggrisWidgetState();
}

class _MKBahasainggrisWidgetState extends State<MKBahasainggrisWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'MKBahasainggris'});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('M_K_BAHASAINGGRIS_arrow_back_rounded_ICN');
                        ...
                        child: Padding(
                          ...
                          child: AuthUserStreamWidget(
                            child: InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'M_K_BAHASAINGGRIS_CircleImage_nwyd0nul_O');
                                logFirebaseEvent(
                  ...
                  itemBuilder: (context, listViewIndex) {
                    ...
                    return Padding(
                      ...
                      child: InkWell(
                        onTap: () async {
                          logFirebaseEvent(
                              'M_K_BAHASAINGGRIS_Container_joqhd84k_ON_');
