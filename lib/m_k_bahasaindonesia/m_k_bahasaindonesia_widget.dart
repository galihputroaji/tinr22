...
class MKBahasaindonesiaWidget extends StatefulWidget {
  const MKBahasaindonesiaWidget({Key? key}) : super(key: key);

  @override
  _MKBahasaindonesiaWidgetState createState() =>
      _MKBahasaindonesiaWidgetState();
}

class _MKBahasaindonesiaWidgetState extends State<MKBahasaindonesiaWidget> {
            ...
            StreamBuilder<List<MateriRecord>>(
              stream: queryMateriRecord(
                queryBuilder: (materiRecord) =>
                    materiRecord.where('mk', isEqualTo: 'Bahasa Indonesia'),
              ),
