...
class MKAgamaWidget extends StatefulWidget {
  const MKAgamaWidget({Key? key}) : super(key: key);

  @override
  _MKAgamaWidgetState createState() => _MKAgamaWidgetState();
}

class _MKAgamaWidgetState extends State<MKAgamaWidget> {
