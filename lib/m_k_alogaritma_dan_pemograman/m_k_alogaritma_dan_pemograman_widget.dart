...
class MKAlogaritmaDanPemogramanWidget extends StatefulWidget {
  const MKAlogaritmaDanPemogramanWidget({Key? key}) : super(key: key);

  @override
  _MKAlogaritmaDanPemogramanWidgetState createState() =>
      _MKAlogaritmaDanPemogramanWidgetState();
}

class _MKAlogaritmaDanPemogramanWidgetState
    extends State<MKAlogaritmaDanPemogramanWidget> {
            ...
            StreamBuilder<List<MateriRecord>>(
              stream: queryMateriRecord(
                queryBuilder: (materiRecord) =>
                    materiRecord.where('mk', isEqualTo: 'Algo dan Pemrograman'),
              ),
